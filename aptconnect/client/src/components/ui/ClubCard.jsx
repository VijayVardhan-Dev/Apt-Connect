...
export default function ClubCard({ club, onClick }) {
  return (
    <article className="group bg-white rounded-xl overflow-hidden border border-gray-200 hover:border-gray-300 hover:shadow-xl transition-all duration-300 w-full h-full flex flex-col">
      <div className="relative overflow-hidden h-40 bg-gray-50 shrink-0">
        <img
          src={club.image}
          alt={club.title}
