...
export const FeatureImagePlaceholder1 = () => (
    <div className="font-poppins w-full aspect-square md:aspect-4/3 bg-gray-300 rounded-2xl flex items-center justify-center shadow-sm hover:shadow-md transition-shadow">
...
export const FeatureImagePlaceholder3 = () => (
    <div className="w-full aspect-square md:aspect-4/3 bg-gray-300 rounded-2xl flex items-center justify-center shadow-sm hover:shadow-md transition-shadow">
        <div className="w-0 h-0 border-l-30 border-l-transparent border-r-30 border-r-transparent border-b-50 border-b-white"></div>
    </div>
);
